const tokenAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_swapThreshold", type: "uint256" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_liquidity", type: "address" },
      { internalType: "address", name: "_development", type: "address" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_development", type: "uint256" },
      { internalType: "uint256", name: "_total", type: "uint256" },
      { internalType: "uint256", name: "_sell", type: "uint256" },
      { internalType: "uint256", name: "_trans", type: "uint256" },
    ],
    name: "setTransactionRequirements",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
